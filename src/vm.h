...
typedef enum {
  ...
  // Calls
  HVM_OP_CALL = 6,            // 1B OP | 8B DEST  | 1B REG
  HVM_OP_CALLSYMBOLIC = 57,   // 1B OP | 4B CONST | 1B REG
  HVM_OP_TAILCALL = 7,        // 1B OP | 8B DEST
  // Invocations
  HVM_OP_INVOKESYMBOLIC = 8,  // 1B OP | 1B REG   | 1B REG
  HVM_OP_INVOKEADDRESS = 9,   // 1B OP | 1B REG   | 1B REG
  HVM_OP_INVOKEPRIMITIVE = 10,// 1B OP | 1B REG | 1B REG
